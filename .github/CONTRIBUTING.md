Contributing to yii2-detail-view
================================
Looking to contribute something to yii2-detail-view? **Here's how you can help.**
...
[extension documentation and demos](http://demos.krajee.com/detail-view) and/or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with yii2-detail-view
-----------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within yii2-detail-view_.
...
- What version of jQuery are you using? And what version of yii2-detail-view?
- Are you using yii2-detail-view with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in yii2-detail-view
------------------------------------------
Before starting work on a major feature for yii2-detail-view, **read the
[documentation](http://demos.krajee.com/detail-view)  first** or you may risk spending a considerable amount of
...
yii2-detail-view regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-detail-view that contain test cases and
...
[issue-tracker]: https://github.com/kartik-v/yii2-detail-view/issues
[licensing]: https://github.com/kartik-v/yii2-detail-view/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-yii2-detail-view
[requesting-features]: #requesting-features-in-yii2-detail-view