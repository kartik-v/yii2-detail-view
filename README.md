...
### Latest Release
The latest version of the extension is release v1.7.5. Refer the [CHANGE LOG](https://github.com/kartik-v/yii2-detail-view/blob/master/CHANGE.md) for details of various releases.
