 ...
 */!function(e){"use strict";var t=function(t,n){var i=this;i.$element=e(t),e.each(n,function(e,t){i[e]=t}),i.init()};t.prototype={constructor:t,init:function(){var e=this;e.initElements(),e.listen()},alert:function(e,t){var n,i=this;return n=i.alertMessageSettings[e],t?(n=n||"alert alert-"+e,i.alertTemplate.replace("{content}",t).replace("{class}",n)):""},initAlert:function(){var t=this,n=t.$element.find(".kv-alert-container");n.find(".alert .close").each(function(){var t=e(this);t.off("click").on("click",function(){setTimeout(function(){n.find(".alert").length||n.hide()},300)})})},listen:function(){var t=this,n=t.$element.find(".kv-alert-container"),i=t.$element.find(".kv-detail-view");t.$btnSave.on("click",function(){n.hide(),i.removeClass("kv-detail-loading").addClass("kv-detail-loading")}),t.$btnUpdate.on("click",function(){t.setMode("edit")}),t.$btnView.on("click",function(){t.setMode("view")}),t.$btnDelete.on("click",function(a){var d=e(this),l=t.deleteParams,s=t.deleteConfirm,r=t.deleteAjaxSettings||{};a.preventDefault(),(!s||confirm(s))&&(r=e.extend({type:"post",dataType:"json",data:l,url:d.attr("href"),beforeSend:function(){n.html("").hide(),i.removeClass("kv-detail-loading").addClass("kv-detail-loading")},success:function(a){a.success&&(i.hide(),t.$btnDelete.attr("disabled","disabled"),t.$btnUpdate.attr("disabled","disabled"),t.$btnView.attr("disabled","disabled"),t.$btnSave.attr("disabled","disabled")),e.each(a.messages,function(e,i){n.append(t.alert(e,i))}),n.hide().fadeIn("slow",function(){i.removeClass("kv-detail-loading"),t.initAlert()})},error:function(a,d,l){var s="";t.showErrorStack&&(s=e.trim(e(a.responseText).text()).replace(/\n\s*\n/g,"\n").replace(/\</g,"&lt;"),s=s.length?"<pre>"+s+"</pre>":""),s=t.alert("kv-detail-error",l+s),i.removeClass("kv-detail-loading"),n.html(s).hide().fadeIn("slow"),t.initAlert()}},r),e.ajax(r))}),t.initAlert()},setMode:function(e){var t=this,n=t.fadeDelay;"edit"===e?(t.$attribs.fadeOut(n,function(){t.$formAttribs.fadeIn(n),t.$element.removeClass("kv-view-mode kv-edit-mode").addClass("kv-edit-mode")}),t.$buttons1.fadeOut(n,function(){t.$buttons2.fadeIn(n)})):(t.$formAttribs.fadeOut(n,function(){t.$attribs.fadeIn(n),t.$element.removeClass("kv-view-mode kv-edit-mode").addClass("kv-view-mode")}),t.$buttons2.fadeOut(n,function(){t.$buttons1.fadeIn(n)}))},initElements:function(){var e=this,t=e.$element;e.$btnUpdate=t.find(".kv-btn-update"),e.$btnDelete=t.find(".kv-btn-delete"),e.$btnView=t.find(".kv-btn-view"),e.$btnSave=t.find(".kv-btn-save"),e.$attribs=t.find(".kv-attribute"),e.$formAttribs=t.find(".kv-form-attribute"),e.$buttons1=t.find(".kv-buttons-1"),e.$buttons2=t.find(".kv-buttons-2")}},e.fn.kvDetailView=function(n){var i=Array.apply(null,arguments);return i.shift(),this.each(function(){var a=e(this),d=a.data("kvDetailView"),l="object"==typeof n&&n;d||(d=new t(this,e.extend({},e.fn.kvDetailView.defaults,l,e(this).data())),a.data("kvDetailView",d)),"string"==typeof n&&d[n].apply(d,i)})},e.fn.kvDetailView.defaults={mode:"view",fadeDelay:800,alertTemplate:"",alertMessageSettings:{},deleteParams:{},deleteAjaxSettings:{},deleteConfirm:"",showErrorStack:!1},e.fn.kvDetailView.Constructor=t}(window.jQuery);